 ...
 * Terminal (font, scrollback, extra keys), Window (tab location), Config file.
 * Appearance / Color scheme are placeholders for the next update. Hotkeys and Plugins are intentionally skipped on mobile
